<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to your <span>{{config('app.name', 'Application Name')}}</span>!
    </div>

    <div class="mt-6 text-gray-500">
        {{config('app.name', 'Application Name')}} provides a beautiful, mobile and secure voting application. Laravel is designed
